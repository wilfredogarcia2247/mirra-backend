...
async function main() {
  ...
  if (!force) {
    console.log('Precaución: este script borrará datos. Para ejecutar exporta FORCE_CLEAR=true o pasa --yes. Ej: FORCE_CLEAR=true node scripts/truncate_all_except_products_users.js');
    process.exit(1);
  }
